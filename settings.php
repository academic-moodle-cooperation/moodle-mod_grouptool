...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_heading(
        'mod_grouptool/view_administration',
    ...
    // Standard groupsize?
    $groupsize = new admin_setting_configtext(
        'mod_grouptool/grpsize',
    ...
    $maxqueues = new admin_setting_configtext(
        'mod_grouptool/users_queues_limit',
        get_string('users_queues_limit', 'grouptool'),
        get_string('cfg_users_queues_limit_desc', 'grouptool'),
        '1',
        PARAM_INT
    );
    ...
    $maxqueues = new admin_setting_configtext(
        'mod_grouptool/groups_queues_limit',
        get_string('groups_queues_limit', 'grouptool'),
        get_string('cfg_groups_queues_limit_desc', 'grouptool'),
        '0',
        PARAM_INT
    );
    $settings->add($maxqueues);
    ...
    $mingroups = new admin_setting_configtext(
        'mod_grouptool/choose_min',
    ...
    $maxgroups = new admin_setting_configtext(
        'mod_grouptool/choose_max',
    ...
    $settings->add(new admin_setting_configcheckbox(
        'mod_grouptool/force_dereg',
        get_string('cfg_force_dereg', 'grouptool'),
        get_string('cfg_force_dereg_desc', 'grouptool'),
        0
    ));
    $settings->add(new admin_setting_configcheckbox(
        'mod_grouptool/show_add_info',
        get_string('cfg_show_add_info', 'grouptool'),
        get_string('cfg_show_add_info_desc', 'grouptool'),
        0
    ));
}
