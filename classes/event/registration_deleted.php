...
class registration_deleted extends \core\event\base {
    ...
    /**
     * Convenience method for registrations deleted via observer/eventhandler
     *
     * @param \stdClass $cm course module object
     * @param \stdClass $regdata registration entries data
     * @return \mod_grouptool\registration_deleted event object
     */
    ...
    /**
     * Convenience method for registrations deleted via direct user action
     *
     * @param \stdClass $cm course module object
     * @param \stdClass $regdata registration entries data
     * @return \mod_grouptool\registration_deleted event object
    ...
    public function get_description() {
        ...
        return "The registration for the user with id '".$this->data['other']['userid'].
               ...
               " in ".$this->objecttable." with course module id '$this->contextinstanceid' has been deleted".$source;
    }
    ...
    protected function validate_data() {
        ...
        if (empty($this->objectid) || empty($this->objecttable)) {
            throw new \coding_exception('The registration_deleted event must define objectid and object table.');
        }
