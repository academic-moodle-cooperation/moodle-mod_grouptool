...
class overview_exported extends \core\event\base {
    /**
     * Init method.
     *
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' exported the overview for '{$this->objecttable}' with the " .
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, $this->objecttable, 'export',
                     ...
                     "&groupid=".$this->data['other']['groupid']."&tab=overview&format=".$this->data['other']['format'],
                     get_string('overview', 'grouptool').' '.$this->data['other']['format_readable'], $this->contextinstanceid);
    }
