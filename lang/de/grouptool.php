...
$string['duedate_help'] = 'Ende des Anmeldezeitraums. Nach diesem Datum können sich Studierende nciht mehr selbstständig anmelden und Lehrende erhalten u.a. Zugriff auf die Warteschlangenauflösung.';
...
$string['toolessegspresent'] = 'Zumindest 1 Nutzer ist in zu wenigen Gruppen angemeldet, daher kann die minimale Anzahl zu wählender Gruppen nicht größer als {$a} eingestellt werden.';
