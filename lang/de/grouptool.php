...
$string['all_groups_full'] = '{$a} kann nicht in Gruppe eingetragen werden, da alle Gruppen voll sind!';
...
$string['groupsize_gets_enabled'] = 'Wenn Sie fortfahren wird die Gruppengröße automatisch aktiviert. Sie können dies verhindern, indem Sie 0 für "{$a->field}" einstellen.';
$string['groupsize_individual_gets_enabled'] = 'Wenn Sie fortfahren wird die individuelle Gruppengröße automatisch aktiviert. Sie können dies verhindern, indem Sie für "{$a->field}" entweder 0 (um die Gruppengröße gar nicht zu benutzen) oder {$a->globalsize} (um die globale Gruppengröße zu nutzen) einstellen!';
...
$string['import_conflict_user_queued'] = 'Teilnehmer/in {$a->fullname} ist bereits in der Warteschlange der Gruppe {$a->groupname}!';
...
$string['import_skipped'] = 'Teilnehmer/in {$a->fullname} wurde für Gruppe {$a->groupname} übersprungen!';
...
$string['reorder_success'] = '';
$string['reorder_failed'] = '';
...
$string['user_move_prev'] = '"{$a->user}" wird von der Warteliste von Gruppe "{$a->from_group}" zur Gruppe "{$a->to_group}" verschoben!';
$string['user_moved'] = '"{$a->user}" wurde von der Warteliste von Gruppe "{$a->from_group}" zur Gruppe "{$a->to_group}" verschoben!';
