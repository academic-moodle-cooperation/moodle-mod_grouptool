...
$string['place_allocated_in_group_success'] = 'Gruppe {$a->group} wurde erfolgreich zur Anmeldung markiert';
...
$string['you'] = 'Sie';
$string['you_are_already_marked'] = 'Sie haben die Gruppe {$a->group} erfolgreich zur Anmeldung markiert!';
$string['your_place_allocated_in_group_success'] = 'Sie haben die Gruppe {$a->group} erfolgreich zur Anmeldung markiert.';