...
$string['groupstatus_help'] = 'Der Status der Gruppe wird durch das jeweilige Ampelsymbol gekennzeichnet:<ul><li>grünes Ampelsymbol - aktive Gruppe. Die Gruppe ist dieser Gruppenverwaltung zugeordnet und steht Studierenden (bei aktivierter Selbstanmeldung) zur Anmeldung zur Verfügung.</li><li>rotes Ampelsymbol - inaktive Gruppen. Die Gruppe wird in dieser Gruppenverwaltung nicht verwendet.</li></ul>';
