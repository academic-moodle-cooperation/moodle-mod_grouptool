...
$string['groupselection_help'] = 'Choose the groups for which you wish to copy the chosen reference-grade and -feedback by activating the corresponding checkboxes.';
...
$string['use_all_or_chosen_help'] = 'If selected "All" a grouping for every course-group will be created. If selected "chosen" only for checked groups below a grouping will be created.';
