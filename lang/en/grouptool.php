...
$string['require_registration_help'] = 'The minium amount of groups students need to register to in order to mark this activity as completed. If the number is higher than 1, "Multiple registrations" needs to be activated and "Maximum groups to choose" needs to be greater or equal to this value';
