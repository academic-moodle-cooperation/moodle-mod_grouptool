...
$string['choose_targetgroup_import'] = 'Import into group';
$string['choose_targetgroup_unregister'] = 'Unregister from groups';
...
$string['notenoughtotalgroups_min'] = 'The set minimum exceeds the total amount of {$a} groups in this instance!';
$string['notenoughactivegroups_min'] = 'The set minimum exceeds the amount of active groups ({$a}) in this instance!';
$string['notenoughtotalgroups_max'] = 'The set maximum exceeds the total amount of {$a} groups in this instance!';
$string['notenoughactivegroups_max'] = 'The set maximum exceeds the amount of active groups ({$a}) in this instance!';
...
$string['unregister_desc'] = 'Unregister mutiple users';
$string['unregister_from_inactive_group_warning'] = 'Note: Group <strong>{$a}</strong> is currently inactive in the grouptool context and will therefore not be displayed. The deregistration will only take place in the Moodle group.';
...
$string['unregisterbutton'] = 'Unregister users';
