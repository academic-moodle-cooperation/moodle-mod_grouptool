...
$string['forceregistration_help'] = 'Note that groups of the grouptool fundamentally differ from the moodle standard groups of the TUWEL course. Tick the checkbox if you want to import the users into the grouptool group as well as into the moodle standard group.';
...
$string['place_allocated_in_group_success'] = 'Group {$a->group} has successfully been marked for registration';
...
$string['your_place_allocated_in_group_success'] = 'You successfully marked group {$a->group} for registration';