...
/**
 * Strings for component 'mod_grouptool', language 'en'
 *
...
$string['allow_unreg_help'] = 'Enable students to deregister from or change to other groups before the (optional) due-date.';
...
$string['modulename_summary'] = 'Manage course groups, enable student self-registration, and streamline group-based workflows.';
$string['modulename_tip'] = 'Use Grouptool to efficiently organize groups, allow self-enrolment, and simplify group management in your Moodle course.';
...
$string['move'] = 'Move';
$string['move_help'] = 'Use the "move" icon to change the order of the groups. Students will see the groups in this order.';
...
$string['registrationmissing'] = '1 registration missing';
...
$string['show_members_help'] = 'Allows students (under certain circumstances) to see who is already registered in a group.<br /><ul><li><strong>No:</strong> Do not show group members.</li><li><strong>All - after due date:</strong> Show all members of all groups after the due date.</li><li><strong>Own - after due date:</strong> Show members only of user`s own group(s) after the due date.</li><li><strong>Own - after registration:</strong> Show members of user`s own group(s) after they are registered.</li><li><strong>Yes:</strong> Show all members of all groups.</li></ul>';
...
$string['size_grp_help'] = 'If "group size" is activated, the maximum number of members for each group is limited.';
