...
$string['notenoughtotalgroups_min'] = 'The set minimum exceeds the total amount of {$a} groups in this course!';
$string['notenoughactivegroups_min'] = 'The set minimum exceeds the amount of active groups ({$a}) in this instance!';
$string['notenoughtotalgroups_max'] = 'The set maximum exceeds the total amount of {$a} groups in this course!';
